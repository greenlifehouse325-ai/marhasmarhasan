/**
 * Permissions Page Content (Client Component)
...
// Dynamic import to prevent SSG serialization issues
const PermissionMatrix = dynamic(
    () => import('@/components/super-admin/PermissionMatrix'),
    { ssr: false }
);

const PermissionMatrixCompact = dynamic(
    () => import('@/components/super-admin/PermissionMatrix').then(mod => ({ default: mod.PermissionMatrixCompact })),
    { ssr: false }
);
